...
public abstract class ActionGUI implements GUI {
	...
	public final ActionGUI addActions(int slot, @Nonnull GUIAction... actions) {
		if (actions == null)
			return this;
	...
	public final ActionGUI setActions(int slot, @Nullable LinkedList<GUIAction> actions) {
		if (actions == null)
	...
	public final ActionGUI clearActions() {
		actions.clear();
		return this;
	}
}
