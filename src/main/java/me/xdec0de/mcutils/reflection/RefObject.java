package me.xdec0de.mcutils.reflection;
 ...
 * <p>
 * You can see an example of this class being used
 * at {@link MCPlugin#registerCommand(me.xdec0de.mcutils.general.MCCommand)},
 * a method that uses CraftServer to get the SimpleCommandMap instance because
 * the {@link Server} interface doesn't contain getCommandMap but the method is
 * public on CraftServer.
 * <p>
