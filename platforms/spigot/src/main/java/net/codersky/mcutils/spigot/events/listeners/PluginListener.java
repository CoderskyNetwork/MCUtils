...
/**
 * A {@link Listener} implementation that is linked to an {@link SpigotPlugin},
 ...
 * 
 * @param <P> An {@link SpigotPlugin} that owns this command listener.
 *
 * @since MCUtils 1.0.0
 * 
 * @author xDec0de_
 ...
 */
public abstract class PluginListener<P extends JavaPlugin> implements Listener {
	 ...
	 * 
	 * @param plugin the {@link SpigotPlugin} that will own this {@link PluginListener}.
	 * 
	...
	/**
	 * Gets the {@link SpigotPlugin} used to instantiate this {@link PluginListener}.
	 * This is also normally the {@link SpigotPlugin plugin} that will register it.
	 * 
	 * @return The {@link SpigotPlugin} used to instantiate this {@link PluginListener}.
	 * 
	 * @since MCUtils 1.0.0
	 */
	@Nonnull
	...
	/**
	 * Shortcut to {@link SpigotPlugin#getConfig()}.
	 * 
	...
	/**
	 * Shortcut to {@link SpigotPlugin#getMessages()}.
	 * 
